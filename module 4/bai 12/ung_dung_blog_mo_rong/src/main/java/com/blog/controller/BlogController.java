...
import com.blog.model.SearchWord;
...
public class BlogController {
    ...
    @ResponseBody
    public List<Blog> findAllBlogByName(@RequestBody String search) {
        List<Blog> blogList = blogService.findAllByTitleContaining(search);
        return blogList;
    }
}
